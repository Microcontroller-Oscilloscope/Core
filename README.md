...
### Hardware:
- Laptop/Computer
- Monitoring device (laptop, computer, phone, etc.)
	- The same laptop/computer can be used as the monitoring device
- Access to a [supported microcontroller](/docs/MC_Support.md)
	- [Unsupported microcontrollers](/docs/Unsupported_Board.md) can be used but require additional work to get operational
- A cable to connect and upload code to. This will vary between microcontrollers and manufacturers
...
- [Application](/docs/Applications.md) for selected monitoring device
...
- Open the repository that corresponds to your microcontroller located [here](/docs/MC_Support.md)
	- Modify `src/board_consts.h` as desired. The base configuration will work for most use cases
